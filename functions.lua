...
var =  'فقلبي ♥️'
elseif  UserID == 1520530041 then
var =  'عمو جمام '
elseif  UserID == 1665690764 then
var =  'مالك السورس'
elseif  UserID == 1463960994 then
var =  'مطور  السورس'
...
function modrem(msg)
if not msg.SudoUser then return '⌯ **عضو ذليل بطل لعب .'end
...
elseif UserID == 1463960994 then 
return sendMsg(ChatID,MsgID,"⌯ **لا يمكنك حظر قلبي\n") 
elseif UserID == 1665690764 then 
...
elseif UserID == 1463960994 then 
return sendMsg(ChatID,MsgID,"⌯ **لا يمكنك كتم جوجل\n") 
elseif UserID == 1665690764 then 
...
elseif UserID == 1463960994 then 
return sendMsg(ChatID,MsgID,"⌯ **لا يمكنك طرد حياتي\n") 
elseif UserID == 1665690764 then 
...
return sendMsg(ChatID,MsgID,"⌯ **لا يمكنك تقييد المطور الاساسي\n") 
elseif UserID == 1463960994 then 
return sendMsg(ChatID,MsgID,"⌯ **لا يمكنك تقييد جوجل\n") 
elseif UserID == 1520530041 then 
