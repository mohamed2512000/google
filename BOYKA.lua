...
usertext = '\nᯓ العضو » ['..result.title_..'](t.me/'..(username or 'M_A_D_O_S')..')'
status  = '\nᯓ تم ترقيته مطور'
...
usertext = '\nᯓ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'M_A_D_O_S')..')'
status  = '\nᯓ تم ترقيته مطور'
...
if BOYKA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'ᯓ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'M_A_D_O_S')..') \nᯓ '..BOYKA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"ᯓ العضو : {["..data.first_name_.."](T.ME/M_A_D_O_S)}\nᯓ ["..BOYKA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "ᯓ عذرا » {["..data.first_name_.."](T.ME/M_A_D_O_S)}\nᯓ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'ᯓ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'M_A_D_O_S')..') \nᯓ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'ᯓ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'M_A_D_O_S')..') \nᯓ تـم قفـل التاك بالكتم ')
end,nil)   
...
if Get_info then
local TextS = "\nᯓ اهلا بك في متجر ملفات مادو\nᯓ ملفات السورس ↓\n 𓇠 ⟼⟼⟼𝒎𝒐𝒂𝒅𝒐𝒐 𖠱²²⟻⟻⟻•\n\n"
local TextE = "\n 𓇠 ⟼⟼⟼𝒎𝒐𝒂𝒅𝒐𝒐 𖠱²²⟻⟻⟻•\nᯓ علامة تعني { ✓ } ملف مفعل\nᯓ علامة تعني { ✘ } ملف معطل\nᯓ قناة سورس مادو ↓\n".."ᯓ [اضغط هنا لدخول](t.me/M_A_D_O_S) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_,"ᯓ عذرا الملف لايدعم سورس مادو \n") 
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\nᯓ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'M_A_D_O_S')..')'
status  = '\nᯓ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\nᯓ العضو » '..userid..''
...
if text == 'مادو' then 
send(msg.chat_id_,msg.id_, '[مطور السورس.](http://t.me/MA_DO_BH) ') 
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\nᯓ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'M_A_D_O_S')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\nᯓ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'M_A_D_O_S')..')'..'\nᯓ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_, t..'ٴᯓ  𓇠 ⟼⟼⟼𝒎𝒐𝒂𝒅𝒐𝒐 𖠱²²⟻⟻⟻•ᯓ○ٴ\nᯓ 彡 .[𝘉𝘖𝘠𝘒𝘈 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/M_A_D_O_S)➢ ')
end
